...
class AppText {
  ...
  static init() {
    ...
    h1 = baseStyle.copyWith(fontSize: AppDimensions.font(18));
    ...
    b1 = baseStyle.copyWith(fontSize: AppDimensions.font(8));
    ...
    l2 = baseStyle.copyWith(fontSize: AppDimensions.font(5));
